...
<div class="text-center">
  <div class="inline-block text-left">
    ...
    <h1 class="pl-7 pr-3 text-5xl font-black italic leading-none tracking-tighter bg-gradient-to-b from-red-400 to-orange-600 bg-clip-text text-transparent">BLAME.TODAY?</h1>
  </div>
